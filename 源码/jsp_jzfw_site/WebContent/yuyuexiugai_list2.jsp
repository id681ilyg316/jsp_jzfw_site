...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
 ...
 <% 
    ...
    String url = "yuyuexiugai_list2.jsp?1=1"; 
    String sql =  "select * from yuyuexiugai where yuyueren='"+request.getSession().getAttribute("username")+"' ";
...
if(request.getParameter("yuyueren")=="" ||request.getParameter("yuyueren")==null ){}else{sql=sql+" and yuyueren like '%"+request.getParameter("yuyueren")+"%'";}
 ...
 <td width='80' align='center'><%=map.get("issh")%></td>
    ...
    <td width="60" align="center"><a href="yuyuexiugai_updt.jsp?id=<%=map.get("id")%>">修改</a>  <a href="yuyuexiugai_list2.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="yuyuexiugai_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
