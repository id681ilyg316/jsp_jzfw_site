...
<%
connstr="DRIVER={SQL Server};Server=.\sqlexpress;UID=sa;PWD=sa123456;DATABASE=jzfw_site;"
set conn=server.createobject("ADODB.CONNECTION")
conn.open connstr

connstr2="DRIVER={SQL Server};Server=.\sqlexpress;UID=sa;PWD=sa123456;DATABASE=hsgsupernews;"
