...
%>
  <form  action="yonghuzhuce_updt2.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1"  onsubmit="return checkform();">
  修改用户注册:
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     *此项不得修改</td>
	 ...
	 <tr><td>身份证：</td><td><input name='shenfenzheng' type='text' id='shenfenzheng' value=''readonly='readonly' /></td></tr>
