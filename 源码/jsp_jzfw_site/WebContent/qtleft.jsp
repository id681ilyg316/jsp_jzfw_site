...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    if((String)request.getSession().getAttribute("username")==null || (String)request.getSession().getAttribute("username")==""){
     %>
	 <form action="jzfw_site?ac=login&a=a" name="f11" style="display: inline">
                                  ...
                                  <tr >
                                    ...
                                    <td width="96"><img src="image.jsp" id="yzm" onClick="ma();" style="cursor:pointer"></img></td>
                                  </tr>
  ...
  <TR>
    <TD height=8></TD></TR></TBODY></TABLE>
      ...
      cellPadding=0 width="92%" align=center 
            border=0><TBODY><TR><TD><P> <% HashMap m1 = new CommDAO().getmaps("leibie","系统公告","dx");out.print(Info.ensubStr(m1.get("content"),185)); %></P></TD></TR></TBODY></TABLE></marquee></TD>
        </TR>
        <TR>
